# Pario Software Factory (PSF) RFCs
...
In short, to get a major feature added to PSF, one usually first gets
the RFC merged into the RFC repo as a markdown file. At that point the RFC
is 'active' and may be implemented with the goal of eventual inclusion
into PSF.

* Fork the RFC repo https://github.com/crvshlab/pario-software-factory-rfcs
...
for inclusion in PSF.
* RFCs that are candidates for inclusion in PSF will enter a "final comment
...
feature as a pull request to the Software Factory repo. Becoming 'active' is not a rubber
...
document somewhat in sync with the implementation feature as planned,
...
On a regular basis the team will attempt to review some set of open RFC
pull requests.
...
**PSF's RFC process owes its inspiration to the [ReactJS RFC process] and [Rust RFC process]**

[ReactJS RFC process]: https://github.com/reactjs/rfcs
